  ...
  /**
    ...
    baidu.object.extend(InfoBox.prototype,{
        ...
        _getCloseIcon: function(){
            ...
            //关闭图标Url为空时，表示不需要关闭按钮
            var img = "";
            if(this._opts.closeIconUrl) {
            	  img = "<img src='"+ this._opts.closeIconUrl +"' align='right' style='position:absolute;right:0px;cursor:pointer;margin:"+ this._opts.closeIconMargin +"'/>";
            }
            return img;
        },
        /**
